...
@section('content')
    ...
    {{-- End Breadcrumb --}}
    {{-- Form --}}
    <form class="needs-validation" action="/mahasiswa/{{ $detail->id }}/edit" method="POST" novalidate>
        @csrf
        <div class="card">
            ...
            <div class="card-body mt-3">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="nim_mahasiswa" value="{{ $detail->nim_mahasiswa }}" name="nim_mahasiswa"
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="nama_mahasiswa" value="{{ $detail->nama_mahasiswa }}" name="nama_mahasiswa"
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" class="form-control" id="tanggal_lahir" value="{{ $detail->tanggal_lahir }}" name="tanggal_lahir" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                        <div class="invalid-feedback">
