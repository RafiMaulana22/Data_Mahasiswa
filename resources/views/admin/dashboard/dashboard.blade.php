                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span class="title text-black font-w600">{{ $jumlah_jurusan }}</span>
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card avtivity-card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span class="title text-black font-w600">{{ $akses_admin }}</span>
                                        </div>
                                    </div>
                                    <div class="progress" style="height:5px;">
                                ...
                                <div class="effect bg-secondary" style="top: -3px; left: 55.7875px;">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span
                                                class="title text-black font-w600">{{ $l }}/{{ $p }}</span>
                                        </div>
                                    </div>
                                    <div class="progress" style="height:5px;">
                            ...
                            <div class="card bg-gra"
                                ...
                                <div class="card-body">
                                    <div class="row d-flex">
                                        <div class="col-md-8">
                                            <h4 class="text-bold text-weight-bolder"
                                                style="color: #000; text-shadow: #fff 1px 2px 2px; margin-bottom:2px;">
                                                <img src="https://unibamadura.ac.id/page/images/profil/1.png"
                                                    width="28" alt="" style="margin-top: -3px">
                                                Informatika<span style="font-size: 14px;"> Uniba
                                                    Madura</span>
                                            </h4>
                                            <span class="mb-5">{{ $today }}</span>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="mt-4">
                                        <h5 class="mb-0" style="color: #008eff">Selamat Datang,
                                            {{ Auth::user()->name }}!</h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
                                        <li class="me-3 mb-2"><i class="las la-clock scale5 me-2"></i><span
                                                class="fs-14 text-black">Last Login </span></li>
                                        <li class="mb-2"><span class="fs-14 text-black font-w500">{{ $lastLogin }}</span>
                                        </li>
                                    </ul>
                                    <ul class="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
                                        <li class="me-3 mb-2"><i class="bi bi-gear scale4 me-2"></i><span
                                                class="fs-14 text-black">IP
                                                Address
                                            </span></li>
                                        <li class="mb-2"><span class="fs-14 text-black font-w500">{{ $ipAddress }}</span>
                                        </li>
                                    </ul>
                                    <ul class="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
                                        <li class="me-3 mb-2"><i class="bi bi-browser-chrome"></i> <span
                                                class="fs-14 text-black">Browser
                                            </span></li>
                                        <li class="mb-2"><span class="fs-14 text-black font-w500">{{ $browser }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
